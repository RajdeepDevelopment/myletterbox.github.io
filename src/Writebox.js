  ...
  return (
    <div>
      ...
      <div  className=" d-flex justify-content-center  row mt-3 gap-5 p-4" >
        ...
        <div className="shadow-lg   col-8  card text-white bg-primary mb-3">
      ...
      <h3>Edit BOX</h3>
       <textarea cols="auto" rows="10" id="editbox" className=" fs-4 border border-info p-4 d-flex justify-content-end " placeholder=" Edit box" />
              <button className=" btn btn-outline-warning  mt-2 mb-5"  id="copytext" onClick={()=>{
                editbox.select();
        ...
        <div className=" col-8 shadow-lg card text-white bg-success mb-3">
          <div className="card-header">Letter</div>
          <div className="card-body">
...
<input className=" d-md-flex border border-info  m-3 p-2 bd-highlight"
 ...
 <h4 id="sub"> Subject: {subject} </h4>
  ...
  <div className="col-5">
  <textarea name="" className="fs-4" id="scndeditbox"  cols="25" rows="20"> Edit Box  </textarea>
...
<button className="btn btn-outline-warning  mt-2 mb-5  "
 onClick={()=>{
  ...
  // copytext1.innerText="Copied";
        ...
        <div className="col-8 card text-dark bg-warning mb-3">
          <div className="card-header">Letter</div>
          <div className="card-body">
            <h5 className="card-title">
            <div className=" d-flex justify-content-end ">
...
<button
      ...
      <textarea   cols="20" rows="10" id="editbox3" className=" fs-4 border border-info p-4 " placeholder=" Edit box" />
              <button className=" btn btn-outline-light  mt-2 mb-5" onClick={()=>{
                editbox3.select();
                document.execCommand("copy");
                const copyelement = document.execCommand("copy");
